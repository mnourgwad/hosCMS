import { Project, mainItem, userPrivilege, User } from "./myInterfaces";
...
const myTestProject: Project = {
  ...
  notes: "test1",
  assignedUsers: [
    {userID: 1, privilegeCode: 1},
    {userID: 2, privilegeCode: 8},
    {userID: 3, privilegeCode: 16}
  ],
  buildingCount: 11,
  buildings: [
    {buildingID: 1, storyCount: 11, buildingName: "A", notes: ""},
    {buildingID: 2, storyCount: 11, buildingName: "B", notes: ""},
    {buildingID: 3, storyCount: 11, buildingName: "C", notes: ""},
    {buildingID: 4, storyCount: 11, buildingName: "D", notes: ""},
    {buildingID: 5, storyCount: 11, buildingName: "E", notes: ""},
    {buildingID: 6, storyCount: 11, buildingName: "F", notes: ""},
    {buildingID: 7, storyCount: 11, buildingName: "G", notes: ""},
    {buildingID: 8, storyCount: 11, buildingName: "H", notes: ""},
    {buildingID: 9, storyCount: 11, buildingName: "I", notes: ""},
    {buildingID: 10,storyCount: 11, buildingName: "J", notes: ""},
    {buildingID: 11,storyCount: 11, buildingName: "K", notes: ""}
  ],
  progress: [
    {subItemID: 15, percentage: 20, userID: 2, entryDate: new Date("23.05.2019 10:34")},
    {subItemID: 15, percentage: 40, userID: 2, entryDate: new Date("27.05.2019 12:20")},
    {subItemID: 12, percentage: 40, userID: 1, entryDate: new Date("27.05.2019 12:20")}
  ]
};
...
const userPrivileges: userPrivilege[] = [
  {privilegeName: "Super user",         privilegeCode: 1},
  {privilegeName: "Admin",              privilegeCode: 2},
  {privilegeName: "Observer",           privilegeCode: 4},
  {privilegeName: "Site Data Entry",    privilegeCode: 8},
  {privilegeName: "Sys Data Entry",     privilegeCode: 16},
  {privilegeName: "Site Manager",       privilegeCode: 32}
];

const users: User[] = [
  {
    userID: 1,
    userNameAr: "Dr.Hossam",
    userNameEn: "Dr.Hossam"
  },
  {
    userID: 2,
    userNameAr: "Dr.Hossam",
    userNameEn: "Eng.Mohammed"
  },
  {
    userID: 3,
    userNameAr: "Mr. Ali",
